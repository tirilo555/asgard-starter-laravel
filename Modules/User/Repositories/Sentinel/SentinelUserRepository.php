...
class SentinelUserRepository implements UserRepository
{
     ...
     * @return User
     */
    public function createWithRoles(array $data, array $roles, bool$activated = false)
    {
        $user = $this->create($data, $activated);
     ...
     * @return User
     */
    public function createWithRolesFromCli(array $data, array $roles, bool $activated = false)
    {
